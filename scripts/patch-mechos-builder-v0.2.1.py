...
MARKER_EARLY = "# MECHOS_V0_2_1_REPAIR_EARLY"
MARKER_LATE = "# MECHOS_V0_2_1_REPAIR_LATE"
CALL_EARLY = f'''\n{MARKER_EARLY}\n# Apply the v0.2.1 runtime repair after the legacy live-welcome block is written.\nbash /workspace/scripts/mechos-v0.2.1-runtime-repair.sh early\n\n'''
...
def main() -> None:
    ...
    backup = target.with_suffix(target.suffix + ".pre-v0.2.1.bak")
